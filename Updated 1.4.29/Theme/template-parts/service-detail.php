...
if ( ! $service ) {
	...
	<main id="main-content">
		<section class="section section-bone"><div class="narrow-container content-card">
			<h1><?php echo esc_html( get_the_title() ); ?></h1>
			<p>اطلاعات این خدمت موقتاً در دسترس نیست. مدیر سایت باید وضعیت محتوای خدمت را بررسی کند.</p>
			<a class="button button-gold" href="<?php echo esc_url( alipasandi_page_url( 'contact' ) ); ?>">تماس با کلینیک</a>
		</div></section>
	</main>
	<?php
	return;
