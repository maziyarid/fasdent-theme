...
define( 'ALIPASANDI_THEME_VERSION', '1.4.24' );
...
function alipasandi_service_plugin_notice() {
	...
	$message = 'missing' === $state
		...
		: 'نسخه Alipasandi Service Content قدیمی است. Theme 1.4.24 به Plugin 1.2.0 یا جدیدتر نیاز دارد.';
	...
	$tests['direct']['alipasandi_service_plugin'] = array(
		...
		'test'  => function () {
			...
			return array(
				...
				'description' => '<p>' . esc_html( 'Theme 1.4.24 requires Alipasandi Service Content >= 1.2.0. Current state: ' . $state ) . '</p>',
