		...
		<div class="site-container contact-grid">
			...
			<div class="contact-side" data-reveal>
				<div class="content-card">
					...
					<?php if ( $maps ) : ?>
						 — <a href="<?php echo esc_url( $maps ); ?>" target="_blank" rel="noopener noreferrer">مشاهده روی نقشه</a>
					<?php endif; ?>
					</p>
					<p><a class="button button-gold" href="<?php echo esc_url( alipasandi_page_url( 'appointments' ) ); ?>">رزرو نوبت نوشهر</a></p>
				</div>
			</div>
		</div>
	</section>
