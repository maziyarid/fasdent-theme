...
5. Install Site Plugin 1.2.0 and edit operational NAP in Settings > اطلاعات کلینیک.
...
= 1.4.22 =
* Moved operational NAP UI, form processing and Rank Math NAP integration to Site Plugin 1.2.0.
