			...
			<div class="split-copy" data-reveal>
				...
				<ul class="credential-list">
					<?php foreach ( $credentials as $credential ) : ?>
						<li><span class="check-circle"><?php alipasandi_the_icon( 'check', 14 ); ?></span><span><?php echo esc_html( $credential ); ?></span></li>
					<?php endforeach; ?>
				</ul>
			</div>
