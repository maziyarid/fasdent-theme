...
function fasdent_enqueue_scripts(): void {
	// Fonts are now loaded in functions.php for React theme
	// Skip loading old CSS/JS files that don't exist in React theme
	if ( ! file_exists( FASDENT_DIR . '/assets/css/main.css' ) && ! file_exists( FASDENT_DIR . '/assets/css/main.min.css' ) ) {
		return;
	}
