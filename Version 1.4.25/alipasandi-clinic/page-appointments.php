...
$max_date   = $today->modify( '+365 days' );
?>
<main id="main-content">
	...
	<section class="section section-bone">
		<div class="narrow-container" id="clinic-form">
			...
			<?php else : ?>
				<div class="booking-shell">
					<div class="form-message error" role="status"><strong>سامانه ثبت درخواست نوبت موقتاً در دسترس نیست.</strong><br>برای هماهنگی، لطفاً مستقیماً با کلینیک تماس بگیرید.</div>
				</div>
			<?php endif; ?>
