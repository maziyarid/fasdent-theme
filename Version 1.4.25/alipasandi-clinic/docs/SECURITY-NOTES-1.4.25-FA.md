# Security Notes — 1.4.25 / Plugin 1.3.0
...
## Mail
Notify Email و From باید explicitly configured باشند. From باید email معتبر روی canonical site domain باشد. `wp_mail=true` فقط قبول transport را نشان می‌دهد؛ Production PASS نیازمند SMTP provider + SPF/DKIM/DMARC + inbox receipt + delivered headers است.
