...
$home_faqs = array(
	array( 'برای درخواست نوبت از کجا شروع کنم؟', 'می‌توانید درخواست نوبت را از فرم آنلاین ثبت کنید یا با کلینیک تماس بگیرید. تاریخ و ساعت انتخاب‌شده پیشنهادی است و پس از تماس کلینیک قطعی خواهد شد.' ),
...
<main id="main-content">
	<section class="home-hero" aria-labelledby="home-hero-title">
		...
		<div class="site-container hero-info-grid" aria-label="اطلاعات سریع کلینیک">
			<div class="hero-info-item"><?php echo alipasandi_icon( 'location', 25 ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?><span><strong>مطب <?php echo esc_html( alipasandi_clinic_option( 'clinic_city' ) ?: 'نوشهر' ); ?></strong><small><?php echo esc_html( alipasandi_clinic_option( 'clinic_street' ) ?: 'ستارخان، امیراد ۱، طبقه ۵' ); ?></small></span></div>
			...
			<?php endif; ?>
			<?php if ( alipasandi_phone_href() ) : ?><a class="hero-info-item" href="tel:<?php echo esc_attr( alipasandi_phone_href() ); ?>"><?php echo alipasandi_icon( 'phone', 25 ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?><span><strong>مشاوره و نوبت‌دهی</strong><small dir="ltr"><?php echo esc_html( alipasandi_clinic_option( 'clinic_phone' ) ); ?></small></span></a><?php endif; ?>
		</div>
	</section>
	...
	<section class="section section-white home-treatment" aria-labelledby="treatment-title">
		<div class="site-container treatment-split">
			<div class="treatment-copy" data-reveal>
				...
				<div class="button-row">
					<a class="button button-gold" href="<?php echo esc_url( alipasandi_page_url( 'appointments' ) ); ?>">درخواست وقت مشاوره</a>
	...
	<section class="section-compact section-dark home-booking-section">
		<div class="site-container final-cta appointment-banner" data-reveal>
			...
			<div class="appointment-banner-copy"><h2>برای دریافت مشاوره یا درخواست نوبت با ما تماس بگیرید.</h2></div>
			<div class="button-row">
