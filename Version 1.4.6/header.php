...
<head>
	...
	<meta name="theme-color" content="<?php echo esc_attr( is_front_page() ? '#2C1D16' : '#101010' ); ?>">
	<?php wp_head(); ?>
</head>
<body <?php body_class(); ?>>
<?php wp_body_open(); ?>
...
<header class="site-header" data-site-header>
	...
	<div id="mobile-menu" class="mobile-menu" role="dialog" aria-modal="true" aria-label="<?php esc_attr_e( 'منوی موبایل', 'alipasandi-clinic' ); ?>" data-mobile-menu hidden>
		<nav class="site-container" aria-label="<?php esc_attr_e( 'منوی موبایل', 'alipasandi-clinic' ); ?>">
			...
			<a class="button button-gold" href="<?php echo esc_url( alipasandi_page_url( 'appointments' ) ); ?>">رزرو نوبت</a>
		</nav>
	</div>
</header>
