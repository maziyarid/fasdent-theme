...
<main id="main-content">
	<section class="home-hero" aria-labelledby="home-hero-title">
		...
		<div class="site-container hero-info-grid" aria-label="اطلاعات سریع کلینیک">
			<div class="hero-info-item"><?php echo alipasandi_icon( 'location', 25 ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?><span><strong>تهران و نوشهر</strong><small>جردن · ستارخان، امیراد ۱</small></span></div>
