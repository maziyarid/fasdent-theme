	...
	<section class="section section-bone">
		<div class="site-container contact-grid">
			<div class="form-card" id="clinic-form" data-reveal>
				...
				<?php elseif ( in_array( $status, array( 'error', 'invalid', 'mail_error', 'configuration_error', 'unavailable' ), true ) ) : ?><div class="form-message error" role="alert">ارسال پیام کامل نشد. لطفاً دوباره تلاش کنید یا مستقیماً تماس بگیرید.</div><?php endif; ?>
				<?php if ( $form_ready ) : ?>
				...
				<?php else : ?>
					<div class="form-message error" role="status" aria-live="polite" aria-atomic="true"><strong>فرم تماس موقتاً در دسترس نیست.</strong><br>لطفاً از شماره تماس رسمی کلینیک استفاده کنید.</div>
				<?php endif; ?>
			</div>
