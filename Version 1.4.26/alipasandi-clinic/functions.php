...
define( 'ALIPASANDI_THEME_VERSION', '1.4.26' );
define( 'ALIPASANDI_SERVICE_PLUGIN_MIN_VERSION', '1.3.1' );
...
function alipasandi_companion_plugin_admin_notice() {
	...
	$message = 'missing' === $state
		...
		: 'نسخه افزونه Alipasandi Service Content قدیمی است. حداقل نسخه 1.3.1 لازم است؛ فرم‌ها و مسیرهای Write تا ارتقا غیرفعال هستند.';
