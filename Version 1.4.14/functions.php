...
define( 'ALIPASANDI_THEME_VERSION', '1.4.14' );
...
function alipasandi_customize_register( $wp_customize ) {
	...
	$settings = array(
		...
		'designer_credit'    => array( 'اعتبار طراحی فوتر', 'طراحی رابط کاربری این وب‌سایت محفوظ است.', 'sanitize_text_field' ),
	);
...
function alipasandi_clinic_option( $key ) {
	$defaults = array(
		...
		'designer_credit'       => 'طراحی رابط کاربری این وب‌سایت محفوظ است.',
	);
