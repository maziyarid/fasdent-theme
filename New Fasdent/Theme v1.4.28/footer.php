	...
	<div class="site-container footer-grid">
		<section class="footer-brand" aria-label="<?php esc_attr_e( 'درباره کلینیک', 'alipasandi-clinic' ); ?>">
			...
			<div class="social-links">
				...
				<?php if ( $whatsapp ) : ?><a href="<?php echo esc_url( $whatsapp ); ?>" target="_blank" rel="noopener noreferrer" aria-label="واتاپ"><?php echo alipasandi_icon( 'whatsapp', 18 ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></a><?php endif; ?>
