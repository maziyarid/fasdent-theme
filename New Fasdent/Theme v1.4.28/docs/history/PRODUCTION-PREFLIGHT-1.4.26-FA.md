...
# Production Preflight — 1.4.26 / Plugin 1.3.1
...
| PHP syntax | BLOCKER | local PHP version only; see BUILD-VALIDATION | PHP 8.2 required (8.0 support removed in 1.4.26/1.3.1 because genuine 8.0 runtime evidence was unavailable) |
